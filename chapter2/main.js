// // Book 2 Chapter 2: dot and bracket notation exercise
...
// console.log('east to west length:', empireStateBuilding.eastWestLength)
// console.log('north to south length:', empireStateBuilding.northSouthLength)

// console.log('address:', empireStateBuilding["address"])
// console.log('date of construction:', empireStateBuilding["constructionDate"])
...
// let emaddress = empireStateBuilding["address"]
// let emdateofconst = empireStateBuilding["constructionDate"]
// let emcost = empireStateBuilding["cost"]
// let emowner = empireStateBuilding["owner"]
// let emarch = empireStateBuilding["architect"]


// // Arrays and values exercise
...
// let ptinstructs = nashvilleSoftwareSchool.instructors.partTime

// for (let i = 0; i < ptinstructs.length; i++) {
//     console.log(ptinstructs[i])
// }

// let ftinstructs = nashvilleSoftwareSchool.instructors.fullTime

// for (let i = 0; i < ftinstructs.length; i++) {
//     console.log(ftinstructs[i])
// }

// console.log(ftinstructs[4], ptinstructs[0])
...
// ${beatles.members[1].birth}. He contributed heabily to the ${beatles.albums[3]} Album`)
...
let peeps = ["Kippers", "Jack", "Gypsy", "Angus", "Seymour Bouts", "Sharky"]
...
console.log(nashvilleSoftwareSchool["instructors"].partTime[1])

console.log(nashvilleSoftwareSchool["instructors"].fullTime[0])
console.log(nashvilleSoftwareSchool["instructors"].fullTime[1])
console.log(nashvilleSoftwareSchool["instructors"].fullTime[2])
